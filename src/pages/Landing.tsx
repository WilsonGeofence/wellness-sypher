            ...
            <div className="relative">
              <div className="rounded-xl overflow-hidden shadow-xl border-8 border-white">
                <img 
                  ...
                  alt="Person tracking health metrics on Sypher app" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="rounded-xl overflow-hidden shadow-lg">
              <img 
                ...
                alt="Health metrics and tracking dashboard" 
                className="w-full object-cover"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              <img 
                ...
                alt="Person tracking fitness goals with a smartwatch" 
                className="w-full object-cover"
              />
            </div>
          </div>
      ...
      <section className="py-20 bg-sypher-blue">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative text-center mt-6 md:mt-0">
              <div className="relative inline-block">
                <img 
                  src="/lovable-uploads/6f69b0b0-6f20-4841-ac2a-c25ee2f86366.png"
                  alt="Sypher mobile app" 
                  className="w-full max-w-[300px] mx-auto rounded-3xl shadow-lg border-4 border-white"
                />
